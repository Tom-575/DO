...
- [x] 竖图/横图导出卡片,封面完整无裁切。(test.md:canvas 680×712 @2x,横图原比例)
- [x] 多图记录点图进全屏,左右滑动可切换,页码正确;单图同样可进。(test.md:页码 1/2→2/2)
- [x] 点文字区仍进编辑态;查看器内可进编辑。(test.md)
- [ ] 真机(手机浏览器)滑动顺滑,无页面滚动穿透。(待用户走查;触屏穿透已按 touch-action 分层预防)
