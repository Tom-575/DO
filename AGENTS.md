...
- 文档地图：`docs/design/DESIGN.md` 是唯一设计规范（基于当前原型的 as-built 基线，含已知问题与下阶段设计任务）；`docs/DO-PROMPT.md` 是 DO 的 AI 行为 Prompt；`research/` 是竞品与视觉参考。旧设计文档（DESIGN_DIRECTION、DESIGN_CONCEPT_V2、DESIGN_GRILL、HANDOFF_RESTART）已于 2026-09-13 删除，不要引用。
